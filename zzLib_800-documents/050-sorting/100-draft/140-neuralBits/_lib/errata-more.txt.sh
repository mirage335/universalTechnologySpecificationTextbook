...
*) MAJOR - &#39;KHFAC block is nearly instantaneous, as shown inFigure 2. A recent study[4]used a ‘counted cycles’ methodto measure the time to achieve complete motor block and found that it could be as rapid as 7.5–14 ms;&#39; - https://www.futuremedicine.com/doi/pdf/10.2217/bem-2017-0004
 ...
 *) &#39;The two important parameters of KHFAC nerve block are frequency and amplitude. Nerve conduction blockrequires a frequency of 1 kHz or higher[13], and typically frequencies of 5 kHz or higher have been used. Therehave been no reports of a ‘maximum plateau’ frequency to achieve KHFAC block, with the highest reportedfrequency being 50 kHz[25].&#39;
 ...
 *) MAJOR - &#39;DC block of neural activity was first demonstrated by Pfl ̈uger[39]and has been reviewed previously[40].Untilrecently, however, the use of DC block was limited to physiological studies in acute animal preparations due to irreversibility of the block when utilized for more than a few minutes[41–43].&#39;
 ...
 *) &#39;Historically, DC block has only been utilized in acute physiological testing because the electrochemical reactionsat the electrode will eventually result in damage to both the nerve and electrode, and is thus unsuitable for long-termacute or chronic applications[42,49–51].&#39;
...
(1×10^6×4×300)×2 == 2.4Gbits (1M neurons bidirectional - spike compressed)

(1×10^6×8×300)x2 == 4.8Gbits (1M neurons bidirectional - IIR compressed)

(1×10^5×8×300)×2 == 0.48Gbits (100k neurons bidirectional - compressed)

(1×10^5×12×7000)×2 == 16.8Gbits (100k neurons bidirectional)

(3840×2160)×32×75×2 == 39.8Gbits (2x4k VR Headset Raw Bandwidth)
...
Amplifier is implied at every ADC input. Amplifier noise floor of &#39; (3Hz - 10KHz)5.9μVRMS &#39; (Neuralink AnalogPixel Specification) seems fairly typical and is only slightly higher than the thermal noise floor at &#39; 38degC,100kOhm &#39; input .
...
(100×10^−9)×10000×2^12/(50000/300) == 0.024576V
0.024576/2^12/10000×(50000/300) == 0.0000001A == 100nA
...
Apparently a notable disadvantage of this system as described may be the rather large footprint per pixel - perhaps approximately - (sqrt(23000×18500)/sqrt(3072) == 372um ) * 2000um . Another notable disadvantage may be power dissipation of ~1W/4000channels , though this reported figure of 0.25uw/channel is five times the reported 5.2uW/AnalogPixel, and may be stimulation power of less thermal consequence.
