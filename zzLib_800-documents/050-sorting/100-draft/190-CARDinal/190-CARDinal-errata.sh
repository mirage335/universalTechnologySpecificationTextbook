...
export fromSelfFolder_errata_more=$(cat "$scriptLib"/REVIEW-errata-more.txt 2>/dev/null)



export fromDocuments_boilerplateDisclaimer_extensiveResearchNotes=$(cat "$zzLib_800_documents_____boilerplate"/z80-boilerplate_disclaimer_extensiveResearchNotes.txt)

export zzLib_800_documents_____boilerplate_____disclaimer_inaccessibleReferences="$zzLib_800_documents_____boilerplate"/z70-boilerplate_disclaimer_inaccessibleReferences.txt.sh
...
_heading2 'errata'
_v "$fromSelfFolder_errata"
_ source "$zzLib_800_documents_____boilerplate_____disclaimer_inaccessibleReferences"
_t ' '
_o_ _safeEcho_newline "$fromDocuments_boilerplateDisclaimer_extensiveResearchNotes"
_heading2 'errata-more'
_v "$fromSelfFolder_errata_more"
...
_default_procedure() {
	...
	pdfunite "$scriptLib"/"$1".pdf "$scriptLib"/CARDinal-errata.pdf "$scriptAbsoluteFolder"/"$1".pdf
